...
windows-cli: ## Download Windows CLI
	[ -f ./build/cli/letheand.exe ] || mkdir -p build/cli && wget https://github.com/letheanVPN/blockchain/releases/latest/download/windows.tar && tar -xvf windows.tar -C ./build/cli/ && rm windows.tar;

linux-cli:  ## Download Linux CLI
	[ -f ./build/cli/letheand ] || mkdir -p build/cli && wget https://github.com/letheanVPN/blockchain/releases/latest/download/linux.tar && tar -xvf linux.tar -C  ./build/cli/ && rm linux.tar;
...
linux-gui:
	cd build && wget https://github.com/letheanVPN/desktop/releases/latest/download/linux-lethean-desktop.tar && tar -xvf linux-lethean-desktop.tar && rm linux-lethean-desktop.tar

linux-server:
	cd build && wget https://github.com/letheanVPN/lethean-server/releases/latest/download/linux.tar && tar -xvf linux.tar && rm linux.tar

macos-amd64-server:
	cd build && wget https://github.com/letheanVPN/lethean-server/releases/latest/download/macos-intel.tar && tar -xvf macos-intel.tar && rm macos-intel.tar

macos-arm64-server:
	cd build && wget https://github.com/letheanVPN/lethean-server/releases/latest/download/macos-arm.tar && tar -xvf macos-arm.tar && rm macos-arm.tar

macos-gui:
	cd build && wget https://github.com/letheanVPN/desktop/releases/latest/download/macos-lethean-desktop.tar && tar -xvf macos-lethean-desktop.tar && rm macos-lethean-desktop.tar
